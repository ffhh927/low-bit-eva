...
"""Pytorch implementation of our 4-bit Shampoo."""
...
from qtensor.utils import QTensorSVDFast, QTensorDiagReal
...
class ShampooSGD(optim.Optimizer):
    def __init__(self,
        ...
        defaults = dict(lr=lr, momentum=momentum, weight_decay=weight_decay, nesterov=nesterov,
                        ...
                        rect_t1=rect_t1, rect_t2=rect_t2, inv_root_mode=inv_root_mode)
            ...
            for p in group['params']:
                ...
                if len(state) == 0:
                    ...
                    state['preconditioner'] = Preconditioner(p, self.name2qmap, 
                        ...
                        rect_t1=group['rect_t1'], rect_t2=group['rect_t2'], inv_root_mode=group['inv_root_mode'])
...
ShampooSGD.__doc__ = r"""
    ...
    Args:
        ...
        rect_t1 (int): number of iterations t1 for rectification
        rect_t2 (int): number of iterations t2 for rectification
        inv_root_mode(int): "0" for SVD computation and "1" for Schur-Newton iteration

    """


ShampooAdamW.__doc__ = r"""
    Implements AdamW+Shampoo.
